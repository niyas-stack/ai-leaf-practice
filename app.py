...
def main():
    ...
    if st.session_state.session_state['pred'] is not None:
      st.markdown(f"<p style='color: yellow;'>Prediction: {st.session_state.session_state['pred']}</p>", unsafe_allow_html=True)
      st.markdown(f"<p style='color: yellow;'>Probability: {st.session_state.session_state['probs']}</p>", unsafe_allow_html=True)
    if st.session_state.session_state['pred'] is not None:
